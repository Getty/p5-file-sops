...
#
# The karr #86 guard could not see it: Format::YAML::_go_float modelled Go with
...
#
# REPAIRED, not refused, unlike karr #86's spellings: sops itself CANNOT write
...
# double the digest covers. That is karr #62's finding and it still holds.
#
...
#    is why the karr #86 guard waved the leaf through. It has to answer what Go
...
#    first document out of a tree and wrong on every later one (karr #88's
...
#    not have started answering anything else differently: karr #86's refusals
#    and karr #86's acceptances both have to survive intact.
###############################################################################
